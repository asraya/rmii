...
class Mst_App extends CI_Controller {
    ...
    {
        $this->load->view('backend/view_table_app');
    }

    public function datatables()
    {
        $list = $this->AppModel->get_datatables();
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->AppModel->count_all(),
                        "recordsFiltered" => $this->AppModel->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        $data = $this->AppModel->get_by_id($id);
    ...
    public function store()
    {
        ...
        $data = array(
                ...
                'app_slug' => strtolower(str_replace(' ', '-', $this->input->post('app_name'))),
        ...
        $insert = $this->AppModel->save($data);
    ...
    public function update()
    {
        ...
        $this->AppModel->update(array('id' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }
