...
class Layanan extends CI_Controller {
    ...
    {
        $this->load->view('backend/cms/layanan');
    }

    public function datatables()
    {
        $list = $this->LayananModel->get_datatables();
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->LayananModel->count_all(),
                        "recordsFiltered" => $this->LayananModel->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        $data = $this->LayananModel->get_by_id($id);
    ...
    public function store()
    {
        ...
        $insert = $this->LayananModel->save($data);
    ...
    public function update()
    {
        ...
        $this->LayananModel->update(array('id' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }
    ...
    public function destroy($id)
    {
        ...
        // $this->LayananModel->delete_by_id($id);
