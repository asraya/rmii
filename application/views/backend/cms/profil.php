                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">profil Page </h2>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title">Tables of profil</h4>
...
$(document).ready(function() {
        ...
        table = $('#show_table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('backend/profil/datatables')?>",
                "type": "POST"
            },
    ...
    function ajax_save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('backend/profil/store')?>";
        } else {
            url = "<?php echo site_url('backend/profil/update')?>";
        }
    ...
    function ajax_edit(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('backend/profil/edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
				'app_name', 'app_slug','link','image','description','image'
        ...
        iziToast.question({
            ...
            buttons: [
                ['<button><b>YES</b></button>', function (instance, toast) {
                    $.ajax({
                        url : "<?php echo site_url('backend/profil/destroy')?>/"+id,
                        type: "POST",
                        dataType: "JSON",
                        success: function(data)
                        {
