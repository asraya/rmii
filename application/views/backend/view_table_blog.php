                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Page Blog</h2>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title">Tables of Blog</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="texteditor" id="blog_content" name="blog_content" placeholder="Blog Content"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
...
$(document).ready(function() {
        ...
        table = $('#show_table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('backend/mst_blog/datatables')?>",
                "type": "POST"
            },
...
$('textarea.texteditor').ckeditor();
    ...
    function ajax_save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('backend/mst_blog/store')?>";
        } else {
            url = "<?php echo site_url('backend/mst_blog/update')?>";
        }
     
        // ajax adding data to database
        var formData = new FormData($('#form_create')[0]);
        formData.append('blog_content', CKEDITOR.instances['blog_content'].getData());
    ...
    function ajax_edit(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('backend/mst_blog/edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
        ...
        iziToast.question({
            ...
            buttons: [
                ['<button><b>YES</b></button>', function (instance, toast) {
                    $.ajax({
                        url : "<?php echo site_url('backend/mst_blog/destroy')?>/"+id,
                        type: "POST",
                        dataType: "JSON",
                        success: function(data)
                        {
